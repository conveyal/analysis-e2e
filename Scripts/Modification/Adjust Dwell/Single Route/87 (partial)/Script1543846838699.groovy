...
WebUI.clickOffset(findTestObject('Misc/Map Pane'), 600, 200)

WebUI.clickOffset(findTestObject('Misc/Map Pane'), 600, 600)

WebUI.clickOffset(findTestObject('Misc/Map Pane'), 800, 600)

WebUI.clickOffset(findTestObject('Misc/Map Pane'), 800, 200)

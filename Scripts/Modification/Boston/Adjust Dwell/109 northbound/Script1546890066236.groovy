...
WebUI.callTestCase(findTestCase('Modification/Shared/Create Modification'), [('modName') : '109 northbound dwells 5 min.'
        , ('modType') : 'Adjust Dwell Time'], FailureHandling.STOP_ON_FAILURE)

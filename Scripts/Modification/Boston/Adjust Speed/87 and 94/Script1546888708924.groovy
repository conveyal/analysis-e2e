...
WebUI.callTestCase(findTestCase('Modification/Shared/Create Modification'), [('modName') : '87 and 94 speed 2x', ('modType') : 'Adjust Speed'], 
...
WebUI.callTestCase(findTestCase('Modification/Shared/Set Route after Feed'), [('routeName') : '94 Medford'], FailureHandling.STOP_ON_FAILURE)
